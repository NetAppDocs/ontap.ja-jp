...
====
.関連情報
* link:https://docs.netapp.com/us-en/ontap-cli/vserver-security-file-directory-show-effective-permissions.html["vserver security file-directory show-effected-permissions"^]
