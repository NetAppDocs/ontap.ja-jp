...
summary: ONTAPには、NFS v4.2セキュリティラベルやNFSを使用したxattrsなど、ファイルレベルのABACを実現するためにお客様が使用できるさまざまなアプローチが用意されています。 
---
...
[role="lead"]
ONTAPには、NFS v4.2セキュリティラベルやNFSを使用した拡張属性（xattrs）など、ファイルレベルの属性ベースアクセス制御（ABAC）を実現するためにお客様が使用できる複数のアプローチが用意されています。
