...
すべての新しいボリュームで Autonomous Ransomware Protection（ARP）がデフォルトで有効になるように ONTAP クラスターを構成する場合は、こちらを参照してくださいlink:enable-default-task.html["関連するARP手順"]。
