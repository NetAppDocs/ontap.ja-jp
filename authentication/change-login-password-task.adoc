...
NOTE: を使用できます `security login role config modify` コマンドを使用して、特定のロールに関連付けられているアカウントのパスワードルールを変更します。詳細については、を参照してください link:https://docs.netapp.com/us-en/ontap-cli-9141/security-login-role-config-modify.html["コマンドリファレンス"^]。
