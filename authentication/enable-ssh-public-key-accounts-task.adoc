...
+
「 security login create -vserver _svm_name __ user-or -group-name user_or -group_name -application_application_-authmethod _authentication_method 」 -role_role_role_-comment_comment _`
