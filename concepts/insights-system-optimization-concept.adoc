...
*推奨*：該当するボリュームに対してAutonomous Ransomware Protectionアクティブモードを有効にします。
 ...
 a| 
ボリュームでSnapshotの自動削除が有効になる
 a| 
要注意
 a| 
Snapshotの自動削除が1つ以上のボリュームで有効になっています。
 a| 
*推奨*：Snapshotの自動削除を無効にします。そうしないと、ランサムウェア攻撃が発生した場合に、これらのボリュームのデータリカバリが不可能になる可能性があります。
...
1つ以上のボリュームに適切なSnapshotポリシーが関連付けられていません。
 a| 
*推奨*：SnapshotポリシーがないボリュームにSnapshotポリシーを適用します。そうしないと、ランサムウェア攻撃が発生した場合に、これらのボリュームのデータリカバリが不可能になる可能性があります。
