...
+
次の例は、元のソースボリューム間の関係を削除します。 `0005` IPアドレス10.0.0.11で、データの提供元のボリューム `volA_dst` オン `svm_backup`：
...
+
次の例は、元のソースボリューム間の関係を反転します。 `0005` IPアドレス10.0.0.11で、データの提供元のボリューム `volA_dst` オン `svm_backup`：
...
+
次の例は、元のソースボリューム間の反転した関係を削除します。 `0005` IPアドレス10.0.0.11で、データの提供元のボリューム `volA_dst` オン `svm_backup`：
