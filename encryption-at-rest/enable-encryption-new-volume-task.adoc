...
|===
+
コマンド構文の詳細については、コマンドリファレンスページのリンク：https://docs.netapp.com/us-en/ontap-cli-9141/volume-create.htmlを参照してください。[`volume create`^]をクリックします。
...
+
コマンド構文全体については、を参照してください link:https://docs.netapp.com/us-en/ontap-cli-9141/volume-show.html["コマンドリファレンス"^]。
