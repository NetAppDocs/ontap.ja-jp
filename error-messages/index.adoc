...
EMS イベントカタログは、次のページの「 More Resources 」で確認できます。 https://mysupport.netapp.com/documentation/productlibrary/index.html?productID=62286["ONTAP 9 製品ライブラリ"^]。を参照してください link:convert-ems-routing-to-notifications-task.html["従来のイベントルートベースのルーティングをイベント通知に変換します"] 通知ベースのモデル変換の実行方法の詳細については、を参照してください。
