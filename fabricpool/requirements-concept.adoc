...
* 接続後にローカル階層からクラウド階層の接続を解除することはできませんが、 link:https://docs.netapp.com/us-en/ontap/fabricpool/create-mirror-task.html["FabricPoolミラー"] をクリックして、別のクラウド階層にローカル階層を接続します。
...
* クラスタ link:https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-licensing-concept.html#data-protection-optimized-license["DP_Optimizedライセンス"]
* Flash Pool アグリゲート
