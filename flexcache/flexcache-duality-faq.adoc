...
標準S3 NASバケットでサポートされているS3操作は、FlexCache S3 NASバケットでサポートされていますが、 `COPY`操作は除きます。標準S3 NASバケットでサポートされていない操作の最新リストについては、link:../s3-multiprotocol/index.html#s3-and-nas-interoperability["相互運用性ドキュメント"]を参照してください。
