...
link:fast-directory-delete-asynchronous-task.html#delete-directories-asynchronously["ONTAP を使用して FlexVol および FlexGroup ボリュームからディレクトリを非同期的に削除する方法について説明します"]。
...
.手順
. クラスタ CLI から、advanced 権限モードに入ります： `-privilege advanced`
