...
+
または、 `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y`コマンドの `--https-only`オプションを使用して、HTTPSのみを指定することもできます。
...
[NOTE]
====
インストール中に署名のチェックをスキップするには、次のコマンドを使用します： `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y --skip-code-signature-check`
