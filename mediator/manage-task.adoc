...
[NOTE]
====
* ONTAPメディエーター1.8以前で使用されるCAファイルは `ca.key`、、 `ca.csr`、 `ca.srl`および `ca.crt`です。ONTAPメディエーター1.9以降で必要なファイルは、、 `intermediate.csr`、 `intermediate.srl`および `intermediate.crt`です `intermediate.key`。
