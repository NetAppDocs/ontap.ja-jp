...
CAUTION: サードパーティの証明書は、特定のバージョンのONTAPのONTAP Mediatorでのみサポートされます。を参照し link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/JiraNgage/CONTAP-243278["NetApp Bugs OnlineのバグIDCONTAP-243278"^]
