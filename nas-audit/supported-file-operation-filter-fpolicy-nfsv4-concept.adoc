...
---
= ONTAP でサポートされている NFSv4 の FPolicy ファイル操作とフィルタ
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
ONTAP 9.19.1以降、管理者はSVMレベルでNFSv4.2の可用性を制御し、System Manager、CLI、またはREST APIを使用して個々のストレージVMのプロトコルを有効または無効にすることができます。
