...
summary: NFS または SMB サーバーを作成する前に、SVM の DNS サービスを設定します。 
---
...
NOTE: DDNS更新に関するRFCルールに準拠していないSVM FQDNの設定エラーを回避するには、RFCに準拠したFQDN名を使用してください。詳細については、link:https://tools.ietf.org/html/rfc1123["RFC 1123"^]を参照してください。
