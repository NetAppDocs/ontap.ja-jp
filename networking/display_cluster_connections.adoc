...
.手順
 ...
 `network connections active show-protocols`の詳細については、link:https://docs.netapp.com/us-en/ontap-cli/network-connections-active-show-protocols.html["ONTAPコマンド リファレンス"^]をご覧ください。
