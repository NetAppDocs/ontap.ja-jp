...
|===
を含むONTAP REST APIの詳細については https://docs.netapp.com/us-en/ontap-automation/whats-new.html["ONTAP REST APIの新機能"^]、ONTAP自動化に関するドキュメントサイトを参照してください。IPSecエンドポイントの詳細については、ONTAPのドキュメントも参照して https://docs.netapp.com/us-en/ontap-automation/reference/api_reference.html["APIリファレンス"^]ください。
