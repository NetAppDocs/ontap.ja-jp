...
summary: クラスタ内のSVMを監視するためにSNMPを設定します。 
---
...
ONTAPシステムでのSNMPサポートの詳細については、 https://www.netapp.com/pdf.html?item=/media/16417-tr-4220.pdf["TR-4220：Data ONTAPにおけるSNMPサポート"^]を参照してください。
