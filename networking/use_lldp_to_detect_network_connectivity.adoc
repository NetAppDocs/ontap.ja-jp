...
隣接デバイスに関する情報を表示するには、イーサネットスイッチとルーターでもLLDPを有効にする必要があります。
...
* クラスターとイーサネットスイッチでは、表示される情報が異なる場合があります。
+
イーサネットスイッチに表示されるシャーシIDとポートIDのデータは、CNAポートと非CNAポートで異なる場合があります。
