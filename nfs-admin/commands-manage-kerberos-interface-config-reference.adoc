...
|===
 `vserver nfs kerberos interface`の詳細については、link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=vserver+nfs+kerberos+interface["ONTAPコマンド リファレンス"^]をご覧ください。
