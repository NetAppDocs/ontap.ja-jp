...
|===
 `vserver services name-service unix-group`の詳細については、link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=vserver+services+name-service+unix-group["ONTAPコマンド リファレンス"^]をご覧ください。
