...
summary: Kerberosは、クライアント/サーバアプリケーションに対して強力で安全な認証を提供します。認証は、サーバに対してユーザとプロセスの ID を検証する機能を提供します。ONTAP 環境では、 Kerberos はStorage Virtual MachineとNFSクライアント間の認証を提供します。 
---
