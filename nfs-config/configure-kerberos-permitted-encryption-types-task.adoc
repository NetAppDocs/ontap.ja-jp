...
summary: デフォルトでは、ONTAPはNFS Kerberosの暗号化タイプとして、DES、3DES、AES-128、およびAES-256をサポートしています。-permitted-enc-typesパラメーターを指定してvserver nfs modifyコマンドを実行すると、各SVMに対して許可される暗号化タイプを、特定の環境のセキュリティ要件に合わせて構成できます。 
---
