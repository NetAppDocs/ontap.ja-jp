...
summary: 個々のローカル UNIX グループを手動で作成する代わりに、vserver services name-service unix-group load-from-uri コマンドを使用して、Uniform Resource Identifier からローカル UNIX グループのリストを SVM にロードできます。 
---
