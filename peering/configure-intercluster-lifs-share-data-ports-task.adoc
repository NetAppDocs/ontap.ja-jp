...
* ONTAP 9.6 以降： *
 a| 
「 network interface create -vserver _system_svm _ -lif_lif_name_service-policy default -intercluster -home-node _node--home-port port -address _port_ip_-netmask netmask _ 」のようになります
