...
| 更新 | 概要 
 ...
 a| 
xref:../anti-ransomware/index.html[追加のハイパーバイザーサポート]
 a| 
ONTAP 9.17.1P5以降、Autonomous Ransomware ProtectionはHyper-V、KVM、およびOpenStackハイパーバイザーをサポートします。
 ...
 a| 
xref:../anti-ransomware/index.html[Autonomous Ransomware Protectionのスナップショットアップデート]
 a| 
ONTAP は、ARP/AI スナップショットにいくつかのアップデートを導入します。
