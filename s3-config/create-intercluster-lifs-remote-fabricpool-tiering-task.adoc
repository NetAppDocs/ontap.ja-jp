...
+
「network interface create -vserver Cluster -lif lif_name」サービスポリシーdefault -intercluster -home-node _node _-home-port port _-address _port_ip_-netmask netmask_’
