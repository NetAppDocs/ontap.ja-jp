...
[ストレージ]>[Storage VM]*を選択し、Storage VMを選択して*[設定]*を選択します。最後に、 image:icon_pencil.gif["編集アイコン"] * S3 の下 * 。
+
...
.. 選択するオプション image:../media/icon_arrow.gif["右矢印"] [* 保護ポリシー * ] の横にある [* 追加 ] をクリックします。
.. ポリシー名と概要を入力します。
...
.. [* アクセス許可 *] タブで、をクリックします image:icon_pencil.gif["編集アイコン"] *[編集]*をクリックし、*[権限]*の*[追加]*をクリックします。
+
