...
summary: LUNをStorage QoSポリシーグループに割り当てることで、LUNへの入出力パフォーマンスを制御できます。ワークロードが特定のパフォーマンス目標を達成するように、あるいは他のワークロードに悪影響を与えるワークロードを制限できるように、入出力パフォーマンスを制御することがあります。 
---
