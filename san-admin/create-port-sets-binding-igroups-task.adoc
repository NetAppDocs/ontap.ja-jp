...
summary: Selective LUN Map を使用する以外にも、ポートセットを作成してポートセットを igroup にバインドすることで、イニシエータが LUN にアクセスするために使用できる LIF をさらに制限できます。ポートセットを igroup にバインドしない場合、その igroup 内のすべてのイニシエータは、LUN を所有するノードおよびその所有ノードの HA パートナー上のすべての LIF を介して、マッピングされた LUN にアクセスできます。 
---
