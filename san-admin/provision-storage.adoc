...
System Manager Classic（9.7以前で使用可能）を使用してこのタスクを完了するには、を参照してください https://["Red Hat Enterprise Linux 向けの iSCSI の設定"^]
...
https://["System ManagerでSANイニシエータグループを表示および管理します"]
