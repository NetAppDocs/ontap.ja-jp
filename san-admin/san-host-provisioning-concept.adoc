...
summary: SAN環境において、ストレージシステムはストレージターゲットデバイスを持つターゲットである。iSCSIおよびFCの場合、ストレージターゲットデバイスはLUNと呼ばれます。Non-Volatile Memory Express over Fibre Channelの場合、ストレージターゲットデバイスはネームスペースと呼ばれます。 
---
