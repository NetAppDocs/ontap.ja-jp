...
サポートされている構成制限に関する最新の詳細情報は、link:https://hwu.netapp.com/["NetApp Hardware Universe"^]で参照できます。


NOTE: これらの制限はASAシステムに適用されます。ASA r2システム（ASA A1K、ASA A90、ASA A70、ASA A50、ASA A30、ASA A20、またはASA C30）をご利用の場合は、link:https://docs.netapp.com/us-en/asa-r2/manage-data/storage-limits.html["ASA r2 システムのストレージ制限"]を参照してください。
...
永続ポートの詳細については、link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080pdf.pdf["NetAppテクニカルレポート4080：最新SANのベストプラクティス"^]を参照してください。
