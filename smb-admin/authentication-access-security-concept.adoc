...
summary: ユーザーがSVMに保存されているデータにアクセスするためのSMB接続を作成する前に、SMBサーバーが属するドメインによって認証される必要があります。SMBサーバーは、KerberosとNTLMの2つの認証方式をサポートしています。Kerberosは、ドメインユーザーの認証に使用されるデフォルトの方法です。 
---
