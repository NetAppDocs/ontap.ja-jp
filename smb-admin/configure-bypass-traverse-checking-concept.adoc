...
summary: トラバース チェックのバイパスは、ユーザがファイルへのパスに含まれるすべてのディレクトリを、たとえそのディレクトリに対する権限を持っていなくても、トラバースできるかどうかを決定するユーザ権限です。バイパス トラバース チェックを許可または禁止した場合に何が起こるか、またStorage Virtual Machine上のユーザに対してバイパス トラバース チェックを設定する方法を理解しておく必要があります。 
---
