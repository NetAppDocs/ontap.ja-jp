...
summary: 中央アクセス ポリシーを使用してCIFSサーバ上のデータへのアクセスを保護するには、いくつかの手順を実行する必要があります。これには、CIFSサーバでDynamic Access Controlを有効にすること、Active Directoryで中央アクセス ポリシーを設定すること、GPOを使用して中央アクセス ポリシーをActive Directoryコンテナに適用すること、およびCIFSサーバでGPOを有効にすることが含まれます。 
---
