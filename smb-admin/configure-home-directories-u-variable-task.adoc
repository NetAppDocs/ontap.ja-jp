...
summary: Windowsのユーザー名変数を使用して共有名を指定し、UNIXのユーザー名変数を使用してホーム ディレクトリ共有への相対パスを指定するホーム ディレクトリ構成を作成できます。ユーザーは、ホーム ディレクトリの実際の名前やパスを意識することなく、Windowsユーザー名を使用して動的に作成された共有フォルダを介してホーム共有に接続できるようになります。 
---
