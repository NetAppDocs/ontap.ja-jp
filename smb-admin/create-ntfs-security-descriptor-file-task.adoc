...
summary: NTFSセキュリティ記述子を作成することは、Storage Virtual Machine内に存在するファイルやフォルダにNTFSアクセス制御リストを設定および適用するための最初のステップです。ポリシータスク内で、セキュリティ記述子をファイルまたはフォルダのパスに関連付けることができます。 
---
