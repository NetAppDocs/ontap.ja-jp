...
summary: ローカル ユーザ アカウントが、CIFSサーバへのローカルSMB認証や、Storage Virtual Machine（SVM）に格納されているデータへのアクセス権の決定に不要になった場合は、Storage Virtual Machineからローカル ユーザ アカウントを削除できます。 
---
