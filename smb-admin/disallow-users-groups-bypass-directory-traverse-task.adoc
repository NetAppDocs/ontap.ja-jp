...
summary: ユーザーが通過したディレクトリに対する権限を持っていないために、ファイルへのパス内のすべてのディレクトリを通過することをユーザーに許可したくない場合は、Storage Virtual Machine上のローカルSMBユーザーまたはグループからSeChangeNotifyPrivilege権限を削除できます。 
---
