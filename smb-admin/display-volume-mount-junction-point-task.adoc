...
summary: ストレージ仮想マシンにマウントされているボリュームに関する情報と、ボリュームがマウントされているジャンクション ポイントを表示できます。また、どのボリュームがジャンクション ポイントにマウントされていないかを特定することもできます。この情報を使用して、SVMネームスペースを理解し、管理できます。 
---
