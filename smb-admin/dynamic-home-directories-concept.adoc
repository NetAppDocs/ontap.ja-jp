...
summary: ONTAPホーム ディレクトリを使用すると、接続するユーザと一連の変数に基づいて、異なるディレクトリにマッピングされるSMB共有を設定できます。ユーザごとに個別の共有を作成する代わりに、ホーム ディレクトリのパラメータをいくつか設定した1つの共有を作成することで、ユーザのエントリ ポイントとホーム ディレクトリ間の関係を定義できます。 
---
