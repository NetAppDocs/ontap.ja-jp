...
summary: CIFSサーバでGroup Policy Objectサポートを有効または無効にすることができます。CIFSサーバでGPOサポートを有効にすると、グループポリシー（CIFSサーバコンピュータオブジェクトを含む組織単位に適用されるポリシー）で定義されている該当するGPOがCIFSサーバに適用されます。 
---
