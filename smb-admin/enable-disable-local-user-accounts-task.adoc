...
summary: ユーザがSMB接続を介してStorage Virtual Machine内のデータにアクセスできるようにする場合は、ローカル ユーザ アカウントを有効にします。また、ユーザがSMBを介してSVMデータにアクセスできないようにする場合は、ローカル ユーザ アカウントを無効にすることもできます。 
---
