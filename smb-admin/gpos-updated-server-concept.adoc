...
summary: デフォルトでは、ONTAPはGroup Policy Objectの変更を90分ごとに取得して適用します。セキュリティ設定は16時間ごとに更新されます。ONTAPが自動的に更新する前に新しいGPOポリシー設定を適用するためにGPOを更新する場合は、ONTAPコマンドを使用してCIFSサーバーで手動更新をトリガーできます。 
---
