...
summary: vserver cifs modifyコマンドを使用してドメインを変更することで、既存のSMBサーバを削除せずにストレージ仮想マシンをActive Directoryドメインに参加させることができます。現在参加しているドメインに再参加することも、新しいドメインに参加することもできます。 
---
