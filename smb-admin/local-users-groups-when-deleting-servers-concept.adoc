...
summary: CIFSサーバが作成されると、デフォルトのローカルユーザとグループのセットが作成され、CIFSサーバをホストするStorage Virtual Machineに関連付けられます。SVM管理者は、いつでもローカルユーザとグループを作成できます。CIFSサーバを削除したときにローカルユーザとグループがどうなるかを把握しておく必要があります。 
---
