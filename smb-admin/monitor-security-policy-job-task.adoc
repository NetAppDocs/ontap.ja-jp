...
summary: ストレージ仮想マシンにセキュリティ ポリシーを適用する際、セキュリティ ポリシー ジョブを監視することで、タスクの進行状況を監視できます。これは、セキュリティ ポリシーの適用が成功したことを確認したい場合に役立ちます。これは、多数のファイルやフォルダに一括でセキュリティを適用するような、長時間実行されるジョブがある場合にも役立ちます。 
---
