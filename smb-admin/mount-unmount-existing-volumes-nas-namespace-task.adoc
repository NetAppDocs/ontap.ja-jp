...
summary: ストレージ仮想マシンボリュームに含まれるデータへのNASクライアントアクセスを設定するには、まずボリュームをNASネームスペースにマウントする必要があります。ボリュームが現在マウントされていない場合は、ジャンクションポイントにマウントできます。ボリュームのマウントを解除することもできます。 
---
