...
summary: Storage-Level Access Guardは、ストレージレベルで追加のセキュリティを提供します。これは、クライアント側からは見えません。したがって、ユーザや管理者は自分のデスクトップからこの権限を取り消すことはできません。ストレージレベルでのアクセス制御機能が有益な特定のユースケースが存在します。 
---
