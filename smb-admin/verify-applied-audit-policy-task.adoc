...
summary: 監査ポリシーを検証することで、セキュリティ ポリシーを適用したStorage Virtual Machine上のファイルまたはフォルダに、目的の監査セキュリティ設定が適用されていることを確認できます。 
---
...
.手順
. 監査ポリシー設定を表示： `vserver security file-directory show -vserver _vserver_name_ -path _path_`
