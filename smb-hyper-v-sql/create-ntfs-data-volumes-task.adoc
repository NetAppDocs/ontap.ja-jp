...
summary: Hyper-VまたはSMB経由のSQL Serverアプリケーションサーバーで使用するために、継続的に利用可能な共有を構成する前に、Storage Virtual Machine上にNTFSデータボリュームを作成する必要があります。ボリューム構成ワークシートを使用して、データボリュームを作成します。 
---
= NTFSデータ ボリュームの作成
:allow-uri-read: 
:icons: font
