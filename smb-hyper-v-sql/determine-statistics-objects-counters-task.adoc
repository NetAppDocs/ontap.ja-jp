...
|===
+
詳細はこちら `statistics catalog object show`そして `statistics catalog counter show`の中でlink:https://docs.netapp.com/us-en/ontap-cli/search.html?q=statistics+catalog["ONTAPコマンド リファレンス"^] 。
