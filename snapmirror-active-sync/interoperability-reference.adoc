...
ONTAP 9.19.1 以降、ARP/AI は SnapMirror アクティブ同期 SAN 関係に参加するプライマリ ボリュームをサポートします。詳細については、link:../anti-ransomware/support-arpai.html#arp-ai-and-virtual-machines["自律型ランサムウェア対策のユースケースと考慮事項"]を参照してください。
