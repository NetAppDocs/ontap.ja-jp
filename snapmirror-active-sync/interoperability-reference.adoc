...
ONTAP 9.19.1 RCから、ARP/AIはSnapMirrorアクティブ同期SAN関係に参加するプライマリボリュームをサポートします。詳細については、link:../anti-ransomware/use-cases-restrictions-concept.html#interoperability-and-vm-considerations["自律型ランサムウェア対策のユースケースと考慮事項"]を参照してください。
