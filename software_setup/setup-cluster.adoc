...
.タスクの内容
この手順は以下に適用されます link:https://docs.netapp.com/us-en/ontap-systems-family/index.html["AFF、 ASA FAS"^] そして link:https://docs.netapp.com/us-en/ontap-afx/index.html["AFXシステム"^]。ASA r2システム（ASA A1K、 ASA A90、 ASA A70、 ASA A50、 ASA A30、 ASA A20、またはASA C30）をお持ちの場合は、 link:https://docs.netapp.com/us-en/asa-r2/install-setup/initialize-ontap-cluster.html["以下の手順を実行します"^] System Manger を使用してONTAPクラスタをセットアップします。ASA r2 システムは、SAN のみのお客様向けに簡素化されたONTAPエクスペリエンスを提供します。
