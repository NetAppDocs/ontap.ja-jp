...
+
。 `-application` のパラメータ `security login` コマンドは、ユーザアカウントのアクセス方法を指定します。。 `security login` https://docs.netapp.com/us-en/ontap-cli-9141_main/security-login-create.html#description["マニュアルページ"^] 追加情報 を含む。
