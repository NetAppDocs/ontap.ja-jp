...
+
** link:https://docs.netapp.com/us-en/ontap-systems/aff-aseries/index.html["AFF Aシリーズシステム"^]
** link:https://docs.netapp.com/us-en/ontap-systems/aff-cseries/index.html["AFF Cシリーズシステム"^]
...
[NOTE]
====
セットアップ GUI を使用してクラスターをセットアップする方法の詳細については、link:../task_admin_add_nodes_to_cluster.html["ノード管理ドキュメント"]を参照してください。 `cluster setup` についての詳細は、link:https://docs.netapp.com/us-en/ontap-cli/cluster-setup.html["ONTAPコマンド リファレンス"^] をご覧ください。
