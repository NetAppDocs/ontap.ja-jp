...
====
AutoSupport OnDemandを無効にして、AutoSupport は有効なままにする場合は、コマンドを使用します。 link:https://docs.netapp.com/us-en/ontap-cli-95/system-node-autosupport-modify.html#parameters["06502a0599b03511ba3f6a4dcdcbba45"]。
