...
.手順
. System Manager で、 * Cluster > Settings * の順にクリックします。
. AutoSupport *セクションで、 image:../media/icon_kabob.gif["kebab アイコン"]をクリックし、 [ 生成と送信 ] をクリックします。
. 件名を入力します。
...
.手順
. System Manager で、 * Cluster > Settings * の順にクリックします。
. AutoSupport *セクションで、 image:../media/icon_kabob.gif["kebab アイコン"]をクリックし、 [ 接続のテスト ] をクリックします。
. メッセージの件名を入力します。
