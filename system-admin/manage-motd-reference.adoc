...
summary: 今日のメッセージは、クラスタレベルまたはSVMレベルで管理できます。デフォルトでは、クラスタ用に構成されたMOTDは、すべてのSVMに対しても有効になります。さらに、各SVMに対してSVMレベルのMOTDを設定できます。クラスタレベルのMOTDは、クラスタ管理者によって各SVMごとに有効または無効に設定できます。 
---
