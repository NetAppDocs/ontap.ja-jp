...
* すべてのボリュームが削除されています link:../volumes/move-volume-task.html["移動しました"] または  ノードが所有するアグリゲートから作成します。
...
* データ LIF が作成されました link:../networking/delete_a_lif.html["削除済み"] または  をクリックします。
