...
summary: オンライン証明書ステータス プロトコルを使用すると、OCSPが有効になっている場合に、トランスポート レイヤ セキュリティ通信を使用するONTAPアプリケーションでデジタル証明書のステータスを受信できます。特定のアプリケーションに対して、OCSP証明書のステータス チェックをいつでも有効または無効にすることができます。デフォルトでは、OCSP証明書のステータス チェックは無効になっています。 
---
