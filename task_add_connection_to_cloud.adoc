...
NOTE: 追加情報で Cloud Insights を使用する場合は、を参照してください link:https://docs.netapp.com/us-en/cloudinsights/task_dc_na_cloud_connection.html["Cloud Insights クラウドエージェントのドキュメント"^]。
