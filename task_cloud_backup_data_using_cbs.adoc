...
. link:https://docs.netapp.com/us-en/occm/task_managing_cloud_central_accounts.html#creating-and-managing-service-acounts["Cloud Manager を使用してアクセスキーとシークレットキーを生成します"]。
