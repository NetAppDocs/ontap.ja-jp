...
summary: ONTAP 9.7 以降の ONTAP 9 リリースで使用できる ONTAP System Manager を使用して、 SMB プロトコルを使用して Windows サーバにストレージを提供するボリュームを作成します。 
---
...
[role="lead"]
ONTAP 9.7 以降の ONTAP 9 リリースで使用できる ONTAP System Manager を使用して、 SMB プロトコルを使用して Windows サーバにストレージを提供するボリュームを作成します。
