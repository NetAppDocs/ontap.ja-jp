...
System Manager Classic （ ONTAP 9.7 以前のリリース）を使用して ESXi ホストからデータストアへの SAN プロトコルアクセスを設定するには、次のトピックを参照してください。 * https://docs.netapp.com/us-en/ontap-sm-classic/fc-config-windows/index.html["Windows 向けの FC 構成の概要"^]*
