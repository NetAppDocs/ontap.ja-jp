...
+
<<<<<<< HEAD 匿名 FTP の場合は、 URL を +ftp://anonymous@ftpserver+ の形式で指定する必要があります。



[]
=====
anonymous FTPの場合、URLは\ftp://anonymous@ftpserverの形式で指定する必要があります。>>>>>>> 20a8478e44f7b38038f6e148d4bfb0026800d5ff
