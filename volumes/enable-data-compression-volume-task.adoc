...
[role="lead"]
volume efficiency modify コマンドを使用すると、 FlexVol ボリュームのデータ圧縮を有効にして、スペースを節約できます。volume efficiency modify コマンドを使用すると、 FlexVol ボリュームのデータ圧縮を有効にして、スペースを節約できます。デフォルトの圧縮形式が適していない場合は、ボリュームに圧縮形式を割り当てることもできます。
