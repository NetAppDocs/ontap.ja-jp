...
+
image:hardware-universe-products.png["Hardware Universe製品メニュー"]

. プラットフォームを選択します。
+
image:hardware-universe-platforms.png["Hardware Universeの[Platforms]メニュー"]

. 適切なバージョンのONTAPを選択し、**Show Results**を選択します。
+
image:hardware-universe-os-filter.png["Hardware Universe OSフィルタメニュー"]
